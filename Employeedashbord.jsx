...
import Empnavnbar from './Empnavnbar';


export default function Emplolyeedashbord() {
...
<div>
    <h1 className='bg-warning text-light text-center fs-1 w=100 'style={{"height":"50px"}}>Welcome to EmployeeDashboard</h1>
<Empnavnbar></Empnavnbar>
